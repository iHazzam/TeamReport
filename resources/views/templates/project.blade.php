        ...
        <table class="tasklists">
            ...
            <tr class="totals">
                <td class="key">Totals</td>
                  <% var percentage = Math.round(( (Math.round(used * 100) / 100)/(Math.round(budget * 100) / 100) )* 100) %>

                <td class="<%= (percentage > 100) ? 'over' : '' %>"><%= Math.round(used * 100) / 100 %> <span class="unit">hrs</span></td>
                <td> <%= Math.round(budget * 100) / 100 %> <span class="unit">hrs</span></td>
                <td class="<%= (percentage > 100) ? 'over' : '' %>" > <%= percentage     %>  <span class="unit">%</span></td>
            </tr>
            </tfoot>
        </table>
    </aside>
